...
public:
    ...
    FMDMetaDataEditorPropertyType& SetValueType(FMDMetaDataEditorPropertyType&& InValueType)
    {
        ValueType.InitializeAs<FMDMetaDataEditorPropertyType>(InValueType);
        return *this;
    }
    ...
    FMDMetaDataEditorPropertyType& SetContainerType(EMDMetaDataPropertyContainerType InContainerType)
    {
